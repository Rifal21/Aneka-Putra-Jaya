...
<main class="h-full pb-16 overflow-y-auto">
  <div class="container px-6 mx-auto grid">
    <!-- General elements -->
    <form method="POST" action="/dashboard/outlet/{{ $outlet->slug }}"  enctype="multipart/form-data">
      @method('put')
      @csrf
      <div class="px-4 py-3 mb-8 bg-white rounded-lg shadow-md dark:bg-gray-800" >
        <label class="block text-sm">
          ...
          <input type="text" name="name_outlet" id="name_outlet"
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('name_outlet') is-invalid @enderror" value="{{ old('name_outlet', $outlet->name_outlet) }}"
        ...
        <label class="block text-sm ">
          ...
          <input name="slug" id="slug" type="text"
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('slug') is-invalid @enderror" value="{{ old('slug', $outlet->slug) }}"
            placeholder="Slug"
          />
          @error('slug')
            <span class="text-xs text-red-600 dark:text-red-400">
        ...
        <label class="block text-sm mb-3">
          ...
          <input name="jadwal" id="jadwal" type="text"
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('jadwal') is-invalid @enderror" value="{{ old('jadwal' , $outlet->jadwal) }}"
            placeholder="jadwal"
          />
          @error('jadwal')
            <span class="text-xs text-red-600 dark:text-red-400">
        ...
        <label class="block text-sm mb-3">
          ...
          <input name="kontak" id="kontak" type="text"
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('kontak') is-invalid @enderror" value="{{ old('kontak' , $outlet->kontak) }}"
            placeholder="kontak"
          />
          @error('kontak')
            <span class="text-xs text-red-600 dark:text-red-400">
        ...
        <label class="block text-sm mb-3">
          ...
          <input name="kantor" id="kantor" type="text"
            class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('kantor') is-invalid @enderror" value="{{ old('kantor' , $outlet->kantor) }}"
            placeholder="kantor"
          />
          @error('kantor')
            <span class="text-xs text-red-600 dark:text-red-400">
