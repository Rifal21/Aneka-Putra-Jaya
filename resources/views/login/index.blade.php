...
<div class="flex justify-center mt-16">
  <div class="w-full max-w-md p-4 bg-white shadow-lg border border-gray-200 rounded-lg  sm:p-6 md:p-8 dark:bg-gray-800 dark:border-gray-700 mt-10 mb-10">
    ...
    <form class="space-y-6" action="/login" method="POST">
      ...
      <div class="flex justify-center">
        ...
        <button type="submit" class="w-full text-white bg-primary hover:bg-hov focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Masuk</button>
