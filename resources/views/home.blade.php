...
<section id="home" class="mb-36">
  <div class="container mx-auto flex flex-col md:flex-row items-center">
    <div class="flex flex-col w-full lg:w-3/4 justify-center items-start pt-12 pb-24 md:pb-0 md:pt-12 px-6">
      @auth
        ...
        @endif
        <h1 class="text-5xl font-bold leading-tight text-gray-900 mb-8">Selamat datang <span class="font-bold text-secondary italic">{!! auth()->user()->name !!}</span> di <span class="font-bold text-nav italic">Apotek AL-Fazza</span></h1>
      @else
        @if (session()->has('success'))
          <div id="toast-simple" class="flex items-center w-full max-w-xs p-4 space-x-4 text-gray-500 bg-bg divide-x divide-gray-200 rounded-lg shadow dark:text-gray-400 dark:divide-gray-700 space-x dark:bg-gray-800" role="alert">
            <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-green-500 bg-green-100 rounded-lg dark:bg-green-800 dark:text-green-200">
        ...
        @endif
        <h1 class="text-5xl font-bold leading-tight text-gray-900 mb-8">Selamat datang di <span class="font-bold text-secondary italic">Apotek AL-Fazza</span></h1>
      @endauth
    ...
    <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
      <img src="img/al fazza.png" alt="product" class="object-cover w-full md:pt-12">
    </div>
  </div>
</section>
  ...
  <div class="flex flex-wrap justify-center">
    @foreach ($categories as $item)
      <div class="max-w-sm rounded overflow-hidden shadow-lg m-4 px-5 mb-5 bg-white transition-all duration-300 ease-in-out transform hover:scale-110 ">
        ...
        @else
          <img src="../../img/obat.png" class="w-full" alt="">
        @endif
...
<section id="produk" class=" pb-10">
  <h1 class="text-2xl font-bold text-center uppercase mb-3 text-dark pt-10">Outlet Kami</h1>
  <div class="flex justify-center mb-20">
